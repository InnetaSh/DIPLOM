...
namespace TranslationApiService.Controllers
{
    ...
    public class OfferTranslationController : TranslationEntityControllerBase<OfferTranslation, TranslationResponse, TranslationRequest>
    {
        public OfferTranslationController(IOfferService offerService, IRabbitMqService mqService)
