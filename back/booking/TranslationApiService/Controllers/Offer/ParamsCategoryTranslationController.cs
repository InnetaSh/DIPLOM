...
namespace TranslationApiService.Controllers
{
    ...
    public class ParamsCategoryTranslationController : TranslationEntityControllerBase<ParamsCategoryTranslation, TranslationResponse, TranslationRequest>
    {
        public ParamsCategoryTranslationController(IParamsCategoryService paramCategoryService, IRabbitMqService mqService)
